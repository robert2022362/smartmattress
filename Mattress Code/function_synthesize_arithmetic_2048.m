function [ flag,heartrate_value ] = function_synthesize_arithmetic_2048( data )
...
possible_interval_flag=0;
possible_interval_flag2=0;
possible_interval_flag3=0;
    %[ ~,possible_interval_flag,F_interval_continuity_HR ,~,~,comparing_times,freq_HR_array] = AM_FREQ_1024( data2,'coif5',0); %a(6)置0
    [ interval_successrate_flag_a,T_interval_continuity_HR_a] = AM_TIME_2048(data2,1,'coif5');%a(6)置1
    [ interval_successrate_flag,T_interval_continuity_HR] = AM_TIME_2048(data2,0,'coif5');%a(6)置0
    [ interval_successrate_flag_cd1,T_interval_continuity_HR_cd1] = AM_TIME_2048_2(data2,'coif5');

    %[ ~,possible_interval_flag2,F_interval_continuity_HR2 ,~,~,comparing_times2,freq_HR_array2] = AM_FREQ_1024( data2,'sym5',0); %a(6)置0
    [ interval_successrate_flag_b,T_interval_continuity_HR_b] = AM_TIME_2048(data2,1,'sym5');%a(6)置1
    [ interval_successrate_flag2,T_interval_continuity_HR2] = AM_TIME_2048(data2,0,'sym5');%a(6)置0
    [ interval_successrate_flag_cd1_2,T_interval_continuity_HR_cd1_2] = AM_TIME_2048_2(data2,'sym5');

    %[ ~,possible_interval_flag3,F_interval_continuity_HR3 ,~,~,comparing_times3,freq_HR_array3] = AM_FREQ_1024( data2,'sym5',0); %a(6)置0
    [ interval_successrate_flag_c,T_interval_continuity_HR_c] = AM_TIME_2048(data2,1,'db5');%a(6)置1
    [ interval_successrate_flag3,T_interval_continuity_HR3] = AM_TIME_2048(data2,0,'db5');%a(6)置0
    [ interval_successrate_flag_cd1_3,T_interval_continuity_HR_cd1_3] = AM_TIME_2048_2(data2,'db5');
...
%}
    ...
    if interval_successrate_flag_a>=1
            flag=2;
